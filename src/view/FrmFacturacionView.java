 ...
 * @author Arthur
 */
public class FrmFacturacionView extends javax.swing.JDialog {

    /**
     * Creates new form FrmClienteView
     */
    public FrmFacturacionView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFacturacionView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmFacturacionView dialog = new FrmFacturacionView(new javax.swing.JFrame(), true);
