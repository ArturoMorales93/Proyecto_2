 ...
 * @author Arthur
 */
public class FrmMantenimientoView extends javax.swing.JDialog {

    /**
     * Creates new form FrmClienteView
     */
    public FrmMantenimientoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtBuscar.setText("Filtrar por ID o Descripción");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMantenimientoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmMantenimientoView dialog = new FrmMantenimientoView(new javax.swing.JFrame(), true);
