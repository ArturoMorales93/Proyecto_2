 ...
 * @author Arthur
 */
public class FrmEmpleadosView extends javax.swing.JDialog {

    /**
     * Creates new form FrmClienteView
     */
    public FrmEmpleadosView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmEmpleadosView dialog = new FrmEmpleadosView(new javax.swing.JFrame(), true);
