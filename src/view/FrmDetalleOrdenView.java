 ...
 * @author Arthur
 */
public class FrmDetalleOrdenView extends javax.swing.JDialog {

    /**
     * Creates new form FrmClienteView
     */
    public FrmDetalleOrdenView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDetalleOrdenView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDetalleOrdenView dialog = new FrmDetalleOrdenView(new javax.swing.JFrame(), true);
