 ...
 * @author Arthur
 */
public class FrmEquiposView extends javax.swing.JDialog {

    /**
     * Creates new form FrmClienteView
     */
    public FrmEquiposView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtBuscar.setText("Filtrar por ID o Marca");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEquiposView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmEquiposView dialog = new FrmEquiposView(new javax.swing.JFrame(), true);
